...
public class MultiThreadSync {
	public char[] arr;
	public int index;
	public MultiThreadSync(char[] arr,int order) {
		this.arr=arr;
		this.index=order;
	}
	...
	public static void main(String[] args) {
		...
		while (in.hasNext()) {
			...
			MultiThreadSync source = new MultiThreadSync(arr, 0);
	...
	class Mythread extends Thread{
		public MultiThreadSync source;
		public char ch;
		public int order;
		public int num;
		Mythread(MultiThreadSync source,char ch,int order,int num){
			this.source=source;
			this.ch=ch;
			this.order = order;
			this.num = num;
